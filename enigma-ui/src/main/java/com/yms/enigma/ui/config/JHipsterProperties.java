...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "enigmaUI@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "enigmaUI API";

        private String description = "enigmaUI API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "enigmaUI";
